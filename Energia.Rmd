...
**Porcentaje pago anticipado canones**, este valor se establece en un 5% del valor total de la concesión
**Porcentaje Royalty**, este se estima en un 5% del valor de los ingresos.


# Valorización Sistema Energia

En este caso se valorizará la 3ra modalidad de negociación. En este caso el valor que representa este negocio a un tercero es de `r dollar(valor.sistema.00.3ro$Energia$vp.base*1e-6)` billones, con una TIR de `r percent(valor.sistema.00.3ro$Energia$tir)`
